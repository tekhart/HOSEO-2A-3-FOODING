...
<body>
	...
	<table class="adminstb3" border="1">
		...
		%>
		<tr>
			<td colspan="8">상품이없습니다. 등록해주세요.</td>
		</tr>
		<%
			} else {
		...
		<tr>
			...
			<td><a
				href="goodsupdate.jsp?productid=<%=article.getProductId()%>">수정</a></td>
			<td><a
				onclick="confirmProdctdelete('<%=article.getProductId()%>')">삭제</a></td>
		</tr>
		<%
			}
			}
	...
	<table class="adminstb2" border="1">
		<tr>
			<td colspan="6" align="center">아래의 분류를 누르시면 해당 분류만 표시됩니다.</td>
		</tr>
		<tr>
		<tr>
			<td colspan="6" align="center" onclick="location.href='goods.jsp'">전체
				상품 분류</td>
		</tr>
		<tr>
			<td colspan="3" width="300px" align="center"
				onclick="location.href='goods.jsp?isTool=2'">재료 : 2</td>
			<td colspan="3" width="300px" align="center"
				onclick="location.href='goods.jsp?isTool=1'">도구 : 1</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" colspan="6"><input type="button"
				class="findbutton2" value="상품 업로드"
				onclick="location.href='goodsupload.jsp'"></td>
		</tr>
	</table>
