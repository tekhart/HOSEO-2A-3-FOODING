				...
				<table id="writetable" align="center" border-spacing="10px"
					...
					<tr>
						<td align="right" colspan="2" onclick="thumbnailupload()">
							<div id="thumbnail"
								style="height: 280px; width: 910px; background-image: url(<%=article.getThumbnail()%>); background-size: cover; background-position: center">
								썸네일</div>
						</td>
					</tr>
					<tr>
						<td width="180" align="center" id="writespace">
							제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
						<td width="330" align="left"><input type="text" size="40"
							maxlength="50" name="title" class="signupinput"
							style="ime-mode: normal;" value="<%=article.getTitle()%>">
						</td>
					</tr>
