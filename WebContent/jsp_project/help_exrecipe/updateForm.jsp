			...
			<form method="post" name="writeform"
				...
				<table id="writetable" align="center" border-spacing="10px">
					...
					<tr>
						...
						<td align="left"><select name='contury'
							...
							style="ime-mode: inactive; ime-mode: inactive; padding: .8em .5em; border-radius: 3px; border-color: #c0c0c0; font-size: 12pt; color: #6f6f6f; font-family: Bauhaus ITC;">
								...
								<option value='1' <%if (article.getDifficulty() == 1) {%>
									selected <%}%>>초급</option>
								<option value='2' <%if (article.getDifficulty() == 2) {%>
									selected <%}%>>중급</option>
								<option value='3' <%if (article.getDifficulty() == 3) {%>
									selected <%}%>>상급</option>
						</select></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td align="left">
							<input type="button" id="button123" value="수정" onclick="writeEnd()">
