...
답변해드리겠습니다.</pre>
	...
	<div class="flip-card4">
		<div class="flip-card-inner4">
			<div class="flip-card-front4"></div>
	...
	<div class="askdiv2">
		...
		<div class="place">
			<table style="border-spacing: 0px;">
				<tr>
					<td class="asktd1" colspan="2">위치 및 운영시간</td>
					<td></td>
				</tr>
				<tr>
					<td class="asktd2">주소</td>
					<td class="asktd2">서울특별시 강서구 등촌3동 강서로 420</td>
				</tr>
				<tr>
					<td class="asktd2">운영시간</td>
					<td class="asktd2">매주 평일 10:00~20:00<br>공휴일, 주말 및 야간에는
						운영하지 않습니다.
					</td>
				</tr>
			</table>
		...
		<div class="warning">
			<table style="border-spacing: 0px;">
				<tr class="asktr1">
					<td class="asktd1">고객센터를 이용하시기 전에 확인해주세요!</td>
				</tr>
				<tr class="placetr2">
					<td class="asktd2">1. 고객센터에서는 FOODING ID 관련 문의, 컨텐츠 등의 <br>&nbsp&nbsp&nbsp문의를
						신속히 도움드릴 수 있습니다.
					</td>
				</tr>
				<tr class="placetr2">
					<td class="asktd2">2. 개발자를 찾아오실때는 간식을 들고오세요.<br>&nbsp&nbsp&nbsp정확한
						상담을 드릴 수 있습니다.
					</td>
				</tr>
			</table>
	...
	<div style="float: right; margin-right: 315px;">
		<input type="button" value="문의하기" class="findbutton"
			onclick="location.href='askform.jsp'">
	</div>
