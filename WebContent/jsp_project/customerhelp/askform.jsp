...
<body>
	...
	<table style="border-spacing: 0px; margin: auto;" width="1000px">
		...
		<tr class="askf">
			<td class="askf5">&nbsp제목</td>
			<td><input type="text" class="whiteinput"></td>
		</tr>
		<tr class="askf">
			<td class="askf5">*이메일</td>
			<td><input type="text" class="whiteinput"
				placeholder="예시) fooding@food.net"></td>
		</tr>
		<tr class="askf">
			<td class="askf5">*문의유형</td>
			<td><select style="padding: 10px;">
		...
		<tr class="askf">
			...
			<td><textarea style="resize: none; border: white;" rows="30"
					cols="110"></textarea></td>
		</tr>
		<tr class="askf2">
			<td class="askf5">&nbsp파일첨부</td>
	...
	<div style="float: right; margin-right: 500px;">
		<input type="button" value="작성완료" class="findbutton"
			onclick="location.href='../mypages/loading.jsp'"> <input
			type="button" value="취소" class="findbutton">
	</div>
