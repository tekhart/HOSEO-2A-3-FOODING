...
<div id="maindiv">
	...
	<form method="POST" action="shopDBassisting_jsp/TestInputing.jsp">
		<table class="list-table" style="border-spacing:0px;margin:auto;">
			<tr>
			...
			<tbody class="list-tabletd">
				...
				<% 
					...
					<%}%>
					<tr>
						<td colspan="2" style="border-bottom:4px solid orange;"></td>
						<td colspan="1" style="border-bottom:4px solid orange;">배송비</td>
						<td colspan="9" style="border-bottom:4px solid orange;">
							<br>
							<%		
		...
		<br><br><br>
		<input type="button" onclick="AllCheckSubmit()" value="전체상품주문" class="longbt1" style="margin-left:250px;">
