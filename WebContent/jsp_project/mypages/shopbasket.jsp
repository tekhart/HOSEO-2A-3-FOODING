...
<body id="body">
	...
	<div id="maindiv">
		...
		<form method="POST" action="paypage.jsp" name="shopbasketForm">
			...
			<div>
				...
				<table width="400px" height="280px"
					style="text-align: center; font-size: 20pt; border-color: #ffbb00; border-width: 3px; border-style: solid; font-family: Bauhaus ITC;"
					align="center">
					<tr>
						<td><br> <br> <span><img
								src="../img/picnic-basket.png" height="60px" width="80px"></span></td>
					</tr>
					<tr>
						<td>
							<h4>장바구니가 비어 있습니다.</h4>
					...
					<tr>
						<td><input type="button" value="상점 가기" class="findbutton"
							onclick="location.href='../shop/main.jsp'"></td>
					</tr>
					<br>
					<br>
					<br>
				...
				<table class="list-table"
					style="border-spacing: 0px; margin: auto; padding-left: 100px;">
					<tr>
						<td align="left"
							style="text-align: left; font-size: 18pt; padding: 80px 0px 5px 10px;">일반상품(<%=count%>)
						</td>
					</tr>
					<tr class="list-tableth">
						<td width="10px;"
							style="border-top: 3px solid orange; border-bottom: 2px solid orange;">
							<label><input type="checkbox" value="alldelete"
								class="BasketMainCheck" onclick="CheckAllSubChecks()" checked></label>
						</td>
						<td width="150"
						...
						<td width="100"
							style="border-top: 3px solid orange; border-bottom: 2px solid orange;"></td>
					</tr>
					...
					<tbody class="list-tabletd">
						...
						%>
						<tr>
							<td width="5%" style="border-bottom: 3px solid orange;"><label><input
									type="checkbox" class="BasketSubCheck" name="CartIdchkbx"
									value="<%=article.getCartId()%>" checked>
 ...
 %>
									...
									<td width="50" style="border-bottom: 3px solid orange;"><input
										type="button" class="img-button"
										onclick="location.href='shopDBassisting_jsp/deletecart_after_clickX.jsp?deletecartid=<%=article.getCartId()%>'">
								</td>
						</tr>
						<%
							}
						...
						<tr>
							<td colspan="2"
								style="border-bottom: 2px solid orange; height: 35px;"></td>
							<td colspan="1"
								style="border-bottom: 2px solid orange; font-size: 16pt;">배송비</td>
							<td colspan="1"
								style="border-bottom: 2px solid orange; font-size: 16pt;">+</td>
							<td colspan="4"
								style="border-bottom: 2px solid orange; font-size: 16pt; text-align: left; vertical-align: middle; display: table-cell; padding-left: 80px;">
								<%
									if (totalprice >= 50000) {
											bae_song_bee = 0;
								%> <del><%=default_bae_song_bee%>원
								</del>=><%=bae_song_bee%> 원 <%
 	} else {
 %> <%=bae_song_bee%> 원 <%
 	}
 %>
						...
						<tr>
							<td colspan="8" height="20px" align="center"
								style="border-bottom: 2px solid orange;"><br> <span
								style="vertical-align: middle; display: table-cell; font-size: 16pt;">
				...
				<br> <br> <br>
				<div align="center">
					<input type="button" onclick="AllCheckSubmit()" value="전체상품주문"
						class="longbt1"> <input type="submit" value="선택상품주문"
						class="longbt2">
				</div>
				<%
					}
