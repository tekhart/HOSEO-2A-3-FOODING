...
<body id="body">
			...
			<div>
				<table class="list-table"
					...
					<tbody class="list-tabletd">
						...
						%>
						<tr>
							<td width="10" style="border-bottom: 3px solid orange;"><label><input
 ...
 %> <br>
						...
						<tr>
							<td colspan="9" height="20px" align="center"
								style="border-bottom: 2px solid orange;"><br>
							<span
				...
				<br>
				<br>
				<br> <input type="button" onclick="AllCheckSubmit()"
					value="전체상품주문" class="longbt1" style="margin-left: 750px;">
