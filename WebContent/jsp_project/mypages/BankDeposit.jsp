			...
			<div class="row2">
				...
				<table class="jugamtable">
					<tr>
						...
						<td><%=buyref%></td>
						<td>주문일</td>
						<td><%=sdf.format(buydate)%></td>
				</table>
				<br> <br>
				<p class="bankinfo">입금하실 은행정보</p>
				<table
					style="border: 3px solid #c0c0c0; border-width: thin; border-collapse: collapse;">
					<tr>
					...
					<tr>
						...
						<td class="banking">주문일로부터 3일간(<%=sdf.format(enddate)%>까지)
						</td>
					</tr>
				</table>
				<div style="text-align: center; margin-top: 40px;">
					<input type="button" value="확인" class="tkdyd4"
						onclick="location.href='../mypages/jumuncheck.jsp'">
				</div>
			</div>
