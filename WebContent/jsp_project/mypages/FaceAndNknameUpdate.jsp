...
<script type="text/javascript">
	...
	function thumbnailupload() {
		window.open("../general_included/thumbUpload/fileForm.jsp?storeplace=userface",
		...
		<form method="post" action="FaceAndNknameUpdatePro.jsp">
			<fieldset style="margin: auto;">
				...
				<input type="hidden" name="id" value="<%=idlogin%>"> <input
					type="hidden" name="userface" value="<%=article.getUserface()%>"
					id="inputthumbnail">

				<table width="80%" height="250px"
					style="font-size: 25px; text-align: center; padding-bottom: 30px;">
					<tr>
						<td colspan="2" style="padding-left: 60px;">* 다른 사람들에게 보여지는
							정보입니다<br>&nbsp;
						</td>
					</tr>
					<tr>
						...
						<div>
							<td style="padding-left: 80px;"><b>닉네임 </b><br> <input
								type="text" class="signupinputs" name="nkname" value="<%=nk%>">
							</td>
						</div>
					</tr>
				</table>
