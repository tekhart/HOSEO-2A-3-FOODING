						...
						<tr>
							...
							<tr class="graphtd">
								<td style="position:relative;">
									<div class="tooltip1" style="height:<%=Writeconturycount[0]*30+5 %>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
										<span class="tooltiptext1"><%=Writeconturycount[0]%></span>
									</div>
									</td>
								<td style="position:relative;">
									<div class="tooltip1" style="height:<%=Writeconturycount[1] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
										<span class="tooltiptext1"><%=Writeconturycount[1]%></span>
									</div>
								</td>
								<td style="position:relative;">
									<div class="tooltip1" style="height:<%=Writeconturycount[2] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
										<span class="tooltiptext1"><%=Writeconturycount[2]%></span>
									</div>
									</td>
								<td style="position:relative;">
									<div class="tooltip1" style="height:<%=Writeconturycount[3]*30+5 %>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
										<span class="tooltiptext1"><%=Writeconturycount[3]%></span>
									</div>
									</td>
								<td style="position:relative;">
									<div class="tooltip1" style="height:<%=Writeconturycount[4] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
										<span class="tooltiptext1"><%=Writeconturycount[4]%></span>
									</div></td>
								<td style="position:relative;">
									<div class="tooltip1" style="height:<%=Writeconturycount[5] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
							...
							<td>
								...
								<table class="grapht">
									<tr class="graphtd">
										<td style="position:relative;">
											<div  class="tooltip1" style="height:<%=WriteFoodtypecount[0]*30+5 %>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
												<span class="tooltiptext1"><%=WriteFoodtypecount[0]%></span>
											</div>
										</td>
										<td style="position:relative;">
											<div class="tooltip1"style="height:<%=WriteFoodtypecount[1] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
												<span class="tooltiptext1"><%=WriteFoodtypecount[1]%></span>
											</div>
										</td>
										<td style="position:relative;">
											<div class="tooltip1"style="height:<%=WriteFoodtypecount[2] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
												<span class="tooltiptext1"><%=WriteFoodtypecount[2]%></span>
											</div>
										</td>
										<td style="position:relative;">
											<div class="tooltip1"style="height:<%=WriteFoodtypecount[3]*30+5 %>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
												<span class="tooltiptext1"><%=WriteFoodtypecount[3]%></span>
											</div>
										</td>
										<td style="position:relative;">
											<div class="tooltip1"style="height:<%=WriteFoodtypecount[4] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
												<span class="tooltiptext1"><%=WriteFoodtypecount[4]%></span>
											</div>
										</td>
										<td style="position:relative;">
											<div class="tooltip1"style="height:<%=WriteFoodtypecount[5] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:20px; ">
												<span class="tooltiptext1"><%=WriteFoodtypecount[5]%></span>
											</div>
										</td>
										<td style="position:relative;">
											<div class="tooltip1"style="height:<%=WriteFoodtypecount[6] *30+5%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px;">
