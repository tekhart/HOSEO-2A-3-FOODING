...
<body id="body">
	...
	<%
		...
		try {
			String sql = "select count(*),foodtype from recipes where writerid = '" + findId
					+ "' group by foodtype;";
			ResultSet rs = foodingbean.resultQuery(sql);
			int i = 0;
			while (rs.next()) {
	...
	<div id="maindiv">
		...
		<div style="margin-left: 550px">
			...
			<div>
				<table
					style="width: 600px; border-collapse: collapse; border-top: 3px solid orange;"
					class="trborder">
					...
					<tr>
						...
						<td rowspan="2" style="padding-top: 50px;">
							<div
								style="height:100px; width:100px; border-radius:50%; border:3px solid orange; margin:auto; background-image:url(<%=userface%>); background-size:cover; background-position:center;" />
						</td>
						<td>
							<h3><%=nk%></h3>
						</td>
					...
					<tr>
						...
						<td><%=email%> (<img src="../img/fork.png"
							style="width: 20px; height: 20px"> : <%=mile%>)</td>
										...
										<table class="grapht">
											<tr class="graphtd">
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=Writeconturylength[0]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
														<span class="tooltiptext1"><%=Writeconturycount[0]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=Writeconturylength[1]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
														<span class="tooltiptext1"><%=Writeconturycount[1]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=Writeconturylength[2]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
														<span class="tooltiptext1"><%=Writeconturycount[2]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=Writeconturylength[3]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
														<span class="tooltiptext1"><%=Writeconturycount[3]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=Writeconturylength[4]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
														<span class="tooltiptext1"><%=Writeconturycount[4]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=Writeconturylength[5]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:15px; ">
									...
									<td>
										...
										<table class="grapht">
											<tr class="graphtd">
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=WriteFoodtypelength[0]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
														<span class="tooltiptext1"><%=WriteFoodtypecount[0]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=WriteFoodtypelength[1]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
														<span class="tooltiptext1"><%=WriteFoodtypecount[1]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=WriteFoodtypelength[2]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
														<span class="tooltiptext1"><%=WriteFoodtypecount[2]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=WriteFoodtypelength[3]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
														<span class="tooltiptext1"><%=WriteFoodtypecount[3]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=WriteFoodtypelength[4]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px; ">
														<span class="tooltiptext1"><%=WriteFoodtypecount[4]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=WriteFoodtypelength[5]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:20px; ">
														<span class="tooltiptext1"><%=WriteFoodtypecount[5]%></span>
													</div>
												</td>
												<td style="position: relative;">
													<div class="tooltip1"
														style="height:<%=WriteFoodtypelength[6]%>px; width:23px; background-color:orange; position:absolute; bottom:0px; left:10px;">
					...
					<tr>
						...
						<td colspan="2">
							<p class="alignleft"></p>
							<p class="aligncenter">
								내가 쓴 레시피 (<%=WriteRecipecount%>)
							</p>
							<p class="alignright">
								댓글 수 (<%=WriteCommentcount%>)
							</p>
						</td>
					...
					<tr>
						<td colspan="2">
							...
							%>
							<div
								onclick="location.href='../recipes/content.jsp?num=<%=article.getNum()%>&pageNum=0&fame=0';">
								<table class="grapht1">
									<tr>
										<td>
											<div
